...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.291' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : 0.291,' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Stats-LikeR" VERSION="0.291">' > Stats-LikeR.ppd
