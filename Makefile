...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.297' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : 0.297,' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Stats-LikeR" VERSION="0.297">' > Stats-LikeR.ppd
