...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.296' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : 0.296,' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Stats-LikeR" VERSION="0.296">' > Stats-LikeR.ppd
