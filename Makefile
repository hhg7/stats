...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.292' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : 0.292,' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Stats-LikeR" VERSION="0.292">' > Stats-LikeR.ppd
