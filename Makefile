...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.294' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : 0.294,' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Stats-LikeR" VERSION="0.294">' > Stats-LikeR.ppd
