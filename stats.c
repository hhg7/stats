...
XS_EUPXS(XS_stats_mean); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_mean)
{
    dVAR; dXSARGS;
...
XS_EUPXS(XS_stats_sd); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_sd)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_stats_var); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_var)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_stats_pearson_r); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_pearson_r)
{
    dVAR; dXSARGS;
    if (items != 2)
...
XS_EUPXS(XS_stats_t_test); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_t_test)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_stats_p_adjust); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_p_adjust)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
...
XS_EUPXS(XS_stats_median); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_median)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_stats_cor); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_cor)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 3)
...
XS_EUPXS(XS_stats_scale); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_scale)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_stats_matrix); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_matrix)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
XS_EUPXS(XS_stats_lm); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_stats_lm)
{
    dVAR; dXSARGS;
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(items); /* -W */
...
#  endif
        ...
        (void)newXSproto_portable("stats::mean", XS_stats_mean, file, "@");
        (void)newXSproto_portable("stats::sd", XS_stats_sd, file, "@");
        (void)newXSproto_portable("stats::var", XS_stats_var, file, "@");
        newXS_deffile("stats::pearson_r", XS_stats_pearson_r);
        newXS_deffile("stats::t_test", XS_stats_t_test);
        newXS_deffile("stats::p_adjust", XS_stats_p_adjust);
        (void)newXSproto_portable("stats::median", XS_stats_median, file, "@");
        newXS_deffile("stats::cor", XS_stats_cor);
