...
use Exporter 'import';
our @EXPORT_OK = qw(cor cor_test fisher_test hist lm matrix mean median min max p_adjust quantile rbinom rnorm runif scale sd seq shapiro_test t_test var);
