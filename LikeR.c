...
XS_EUPXS(XS_Stats__LikeR_aoh2hoh); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Stats__LikeR_aoh2hoh)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "aoh_ref, pivot_key_sv = NULL");
    {
	SV *	aoh_ref = ST(0)
;
	SV *	pivot_key_sv;
...
#  endif
        ...
        newXS_deffile("Stats::LikeR::aoh2hoh", XS_Stats__LikeR_aoh2hoh);
