...
XS(XS_Stats__LikeR__chisq_c); /* prototype to pass -Wmissing-prototypes */
XS(XS_Stats__LikeR__chisq_c)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(boot_Stats__LikeR)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("Stats::LikeR::_chisq_c", XS_Stats__LikeR__chisq_c, file);
